...
<div style="display: flex; align-items: center;">
        <div class="profile-content">
          <h2>» Hello<img src="https://github.com/TheDudeThatCode/TheDudeThatCode/blob/master/Assets/Hi.gif" width="29">, I am <a href="https://ghubrakesh.github.io/">Rakesh</a>.</h2>
          <ul>
            <li>An open source enthusiast 🌏</li>
            <li>A DevOps Guy :computer:</li>
            <li>A Backend Engineer 🙎🏻‍♂️</li>
            <li>A Machine Learning enthusiast 🧮</li>
            <li>A Hashnode <a href="https://imsrakesh.hashnode.dev">Blogger</a> 📃</li>
            <li>A Pythonist 🐍</li>
            <li>A Cricket♥️er 🏏</li>
            <li>A full-time Astrophile :rocket: :milky_way:</li>
          </ul>
        </div>
        <div style="margin-left: auto !important;">
          <img src="https://images.indianexpress.com/2020/11/Google-logos.jpg?w=414">
        </div>
      </div>
